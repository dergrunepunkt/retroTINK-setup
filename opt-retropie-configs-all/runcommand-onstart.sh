...
vcgencmd hdmi_timings 480 1 48 192 240 240 1 3 3 16 0 0 0 59.92 0 37680000 1
tvservice -e "DMT 87"
...
vcgencmd hdmi_timings 480 1 48 192 280 288 1 3 10 6 0 0 0 59.92 0 38400000 1
tvservice -e "DMT 87"
...
vcgencmd hdmi_timings 480 1 152 250 280 224 1 13 8 19 0 0 0 59.185 0 40660000 1
tvservice -e "DMT 87"
fbset -depth 32 && fbset -depth 32 -xres 480 -yres 224
;;

"pcengine") # Load NEC PC Engine timings
vcgencmd hdmi_timings 480 1 152 250 280 240 1 3 3 16 0 0 0 59.94 0 40870000 1
tvservice -e "DMT 87"
fbset -depth 32 && fbset -depth 32 -xres 480 -yres 240
;;
...
vcgencmd hdmi_timings 480 1 160 200 286 224 1 9 8 21 0 0 0 60.10 0 40410000 1
tvservice -e "DMT 87"
fbset -depth 32 && fbset -depth 32 -xres 480 -yres 224
;;
...
vcgencmd hdmi_timings 480 1 48 192 240 248 1 3 10 6 0 0 0 60 0 38400000 1
tvservice -e "DMT 87"
fbset -depth 32 && fbset -depth 32 -xres 480 -yres 240
;;

"gb") # Load Game Boy timings
vcgencmd hdmi_timings 480 1 48 192 280 288 1 3 10 6 0 0 0 59.73 0 38400000 1
tvservice -e "DMT 87"
fbset -depth 32 && fbset -depth 32 -xres 480 -yres 288
;;
...
vcgencmd hdmi_timings 480 1 48 192 300 320 1 3 10 6 0 0 0 59.73 0 38400000 1
tvservice -e "DMT 87"
fbset -depth 32 && fbset -depth 32 -xres 480 -yres 320
;;

"ngp") # Load SNK Neo Geo Pocket timings
vcgencmd hdmi_timings 480 1 160 200 228 228 1 9 8 21 0 0 0 60 0 40410000 1
tvservice -e "DMT 87"
...
vcgencmd hdmi_timings 480 1 48 192 200 248 1 3 10 6 0 0 0 59.92 0 38400000 1
tvservice -e "DMT 87"
fbset -depth 32 && fbset -depth 32 -xres 480 -yres 200
;;

"atari5200") # Load Atari 5200 timings
vcgencmd hdmi_timings 480 1 48 192 240 248 1 3 10 6 0 0 0 59.92 0 38400000 1
tvservice -e "DMT 87"
fbset -depth 32 && fbset -depth 32 -xres 480 -yres 240
;;
